...
public class LineGridView extends GridView {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        localPaint.setStrokeWidth(dp2px(getContext(), 1));
        localPaint.setColor(LINE_COLOR);//设置画笔的颜色
        //localPaint.setColor(getContext().getResources().getColor(R.color.icbc_service_grid_line));//设置画笔的颜色
