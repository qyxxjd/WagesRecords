 ...
 */
public class PizzaHutRulesContentViewDisplay extends BaseRulesContentViewDisplay {

    private String mHourlyWage;
    private String mRestHourlyWage;
    private String mNightSubsidy;

    public PizzaHutRulesContentViewDisplay(@NonNull Activity activity,
        ...
        mRestHourlyWage = MoneyUtil.replace(mSpUtil.getStringValue(
                                        Consts.SP_PIZZA_HUT_REST_HOURLY_WAGE,
                                        Consts.DEFAULT_HOURLY_WAGE));
        mNightSubsidy = MoneyUtil.replace(mSpUtil.getStringValue(
        ...
        displayInputDialog(R.string.setup_hourly_wage,
                ...
                new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                        ...
                        mSpUtil.putStringValue(Consts.SP_PIZZA_HUT_HOURLY_WAGE, input.toString());
        ...
        displayInputDialog(R.string.setup_rest_hourly_wage,
                ...
                new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                        ...
                        mSpUtil.putStringValue(Consts.SP_PIZZA_HUT_REST_HOURLY_WAGE, input.toString());
                        ToastUtil.showToast(mAppContext, R.string.setup_success);
                        notifyRecalculation();
                    }
                });
        ...
        displayInputDialog(R.string.setup_night_subsidy,
                ...
                new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                        ...
                        mSpUtil.putStringValue(Consts.SP_PIZZA_HUT_NIGHT_SUBSIDY, input.toString());
                        ToastUtil.showToast(mAppContext, R.string.setup_success);
                        notifyRecalculation();
                    }
                });
