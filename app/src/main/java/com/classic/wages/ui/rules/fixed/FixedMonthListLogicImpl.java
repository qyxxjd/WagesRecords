 ...
 */
public class FixedMonthListLogicImpl extends BaseListLogicImpl<WorkInfo> {

    private final float mHourlyWage;

    public FixedMonthListLogicImpl(@NonNull Context context, @NonNull IDao<WorkInfo> dao) {
