        ...
        displayInputDialog(R.string.setup_hourly_wage,
                ...
                new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                        ...
                        Util.putPreferencesString(Consts.SP_FIXED_DAY_HOURLY_WAGE, value);
        ...
        displayInputDialog(R.string.setup_fixed_hours,
                ...
                new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                        ...
                        Util.putPreferencesString(Consts.SP_FIXED_DAY_FIXED_HOURS, value);
                        ToastUtil.showToast(mAppContext, R.string.setup_success);
                        notifyRecalculation();
                    }
                });
        ...
        displayInputDialog(R.string.setup_overtime_hourly_wage,
                ...
                new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                        ...
                        Util.putPreferencesString(Consts.SP_FIXED_DAY_OVERTIME_HOURLY_WAGE, value);
                        ToastUtil.showToast(mAppContext, R.string.setup_success);
                        notifyRecalculation();
                    }
                });
